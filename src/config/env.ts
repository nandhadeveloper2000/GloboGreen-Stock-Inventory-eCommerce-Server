...
export const env = {
  ...
  EXTERNAL_SEARCH_PROVIDER: getEnv("EXTERNAL_SEARCH_PROVIDER", "auto"),
  BRAVE_SEARCH_API_KEY: getEnv(
    "BRAVE_SEARCH_API_KEY",
    getEnv("BRAVE_SEARCH_API_TOKEN")
  ),
  GOOGLE_PROGRAMMABLE_SEARCH_API_KEY: getEnv(
    "GOOGLE_PROGRAMMABLE_SEARCH_API_KEY",
    getEnv("GOOGLE_CUSTOM_SEARCH_API_KEY")
  ),
  GOOGLE_PROGRAMMABLE_SEARCH_ENGINE_ID: getEnv(
